    ...
    for event in pygame.event.get():
      ...
      if event.type==pygame.QUIT:
        ...
        if mouse_pos[0]>round(size[0]/4) and mouse_pos[0]<round(size[0]/4)+round(size[0]/2) and mouse_pos[1]>round(size[1]*1/3) and mouse_pos[1]<round(size[1]*1/3)+round(size[1]/6):
          ...
          if SCORE>MAX_SCORE:
            MAX_SCORE=SCORE
        elif mouse_pos[0]>round(size[0]/4) and mouse_pos[0]<round(size[0]/4)+round(size[0]/2) and mouse_pos[1]>round(size[1]*2/3) and mouse_pos[1]<round(size[1]*2/3)+round(size[1]/6):
          main.AIrunGame()
